...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, borderline west={3pt}{0pt}{shadecolor}, colback={codebgcolor}, sharp corners, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
\makeatother
