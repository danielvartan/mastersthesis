...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}, colback={codebgcolor}, sharp corners, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi
\makeatother
