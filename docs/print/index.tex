...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, frame hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, colback={codebgcolor}, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
...
to the thesis subject, providing also its justification and aims. The
subsequent chapters consist of a series of essays and a article
connected to the thesis, with the exception of the last one, which
encompasses a general discussion and final remarks.
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, breakable, leftrule=.75mm, rightrule=.15mm, opacitybacktitle=0.6, colback=white, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, left=2mm, arc=.35mm]
