...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, frame hidden, sharp corners, enhanced, colback={codebgcolor}, breakable]}{\end{tcolorbox}}\fi
\makeatother
...
\includegraphics{qmd/images/mctq-figure-1.png}
...
populations at higher latitudes tend toward eveningness
...
\includegraphics[width=0.95\textwidth,height=\textheight]{qmd/images/hut-2013-figure-1.png}
...
\caption{\label{fig-chapter-4-leocadio-miguel-2017-figure-2}The mean
scores (±SE) on the Horne \& Östberg (HO) chronotype scale
\autocite{horne1976} are presented across a latitudinal gradient, along
with the corresponding annual average solar irradiation levels (W/m²).
The HO scale comprises 19 items, with total scores ranging from 16 to
86; lower scores indicate a stronger evening orientation, while higher
scores reflect a greater morning orientation. Notably, the y-axis
exaggerates the visual impact of the differences, as it represents a
range of only about 4.5 points, which may overstate the perceived
significance of the effect.}

\centering{

\includegraphics[width=0.75\textwidth,height=\textheight]{qmd/images/leocadio-miguel-2017-figure-2.png}
...
aims to address that gap. In the following sections, the hypothesis will
be tested using one of the largest chronotype datasets, to the author's
knowledge, with geocoding information integrated for a comprehensive
analysis. The approach will adhere to sound statistical principles,
incorporating a minimum effect size in the alternative hypothesis, as
...
\includegraphics{qmd/chapter-5_files/figure-pdf/unnamed-chunk-7-1.png}
...
standard deviation of \(\text{01:26:13}\). The distribution curve is
shown in Figure~\ref{fig-chapter-5-chronotype-distribution}.
...
\includegraphics{qmd/chapter-5_files/figure-pdf/unnamed-chunk-8-1.png}
...
\includegraphics{qmd/chapter-5_files/figure-pdf/unnamed-chunk-9-1.png}
...
\includegraphics{qmd/chapter-5_files/figure-pdf/unnamed-chunk-10-1.png}
