...
fit |> 
  ...
  ggplot2::geom_boxplot(
    outlier.colour = get_brand_color("orange"), 
    outlier.shape = 1,
    width = 0.5
  ) +
...
plot <- 
  ...
  ggplot2::geom_smooth(color = get_brand_color("orange")) +
...
for (i in seq_along(plots)) {
  ...
  q$data[[1]]$colour <- get_brand_color("orange")
  q$plot$layers[[1]]$constructor$color <- get_brand_color("orange")
