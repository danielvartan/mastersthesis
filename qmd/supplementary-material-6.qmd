...
As shown in @sec-on-the-latitude-hypothesis, the hypothesis implies linearity and the distribution of the residuals also support this.
:::
...
write_in_results_yml(
  list(
    ...
    htb_effect_size = 
      effect_size |> 
      tidyr::pivot_wider() |> 
      dplyr::mutate(f_squared = f_squared |> as.numeric())
  )
)
```
