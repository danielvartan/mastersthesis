...
After this process, the postal codes were matched with the [QualoCEP](https://www.qualocep.com/) database to check if they exist. Existing postal codes were than validated by the following rules:
