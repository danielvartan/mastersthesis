...
[Source: Reproduction from @hut2013[Figure 1.]{.legend}

Annual changes in (a) twilight duration, (b) daylight hours, and (c) temperature across different latitudes. `\microskip \\`{=latex} Each color shows a specific latitude, illustrating how these factors vary throughout the year.
:::
...
[Source: Created by the author. Adapted from `\\`{=latex} @roenneberg2003[Figure 7F].]{.legend}

Different chronotype distributions, influenced by strong and weak zeitgebers -- orange for strong (leptokurtic) and black for weak (platykurtic). `\microskip \\`{=latex} An illustration of the effect hypothesized by the latitude hypothesis.
:::
