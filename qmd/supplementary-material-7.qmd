...
This document presents the analysis for testing the thesis hypothesis (**Test A**) using the methodology outlined in Supplementary Material [-@sec-sm-methods].
...
::: {#tbl-sm-7-residual-diag-normality-1}
```{r}
#| code-fold: true
...
::: {#fig-sm-7-residual-diag-normality-2}
```{r}
#| code-fold: true
...
::: {#fig-sm-7-residual-diag-normality-3}
```{r}
#| code-fold: true
...
::: {#tbl-sm-7-residual-diag-normality-2}
```{r}
#| code-fold: true
...
::: {#fig-sm-7-residual-diag-fitted-values-1}
```{r}
#| code-fold: true
...
::: {#fig-sm-7-residual-diag-linearity-1}
```{r}
#| code-fold: true
...
::: {#fig-sm-7-diag-homoscedasticity-1}
```{r}
#| code-fold: true
...
{{< include ../qmd/_tabset-panel-sm-7-var-homoscedasticity.qmd >}}
...
@tbl-sm-7-residual-diag-independence-1 shows the relative importance of independent variables in determining the response variable. It highlights how much each variable uniquely contributes to the R-squared value, beyond what is explained by the other predictors.

::: {#tbl-sm-7-residual-diag-independence-1}
```{r}
#| code-fold: true
...
::: {#fig-sm-7-model-diag-collinearity-fm-1}
```{r}
#| code-fold: true
...
::: {#tbl-sm-7-residual-diag-collinearity-1}
```{r}
#| code-fold: true
...
::: {#tbl-sm-7-residual-diag-collinearity-2}
```{r}
#| code-fold: true
...
::: {#tbl-sm-7-residual-diag-collinearity-3}
```{r}
#| code-fold: true
...
{{< include ../qmd/_tabset-panel-sm-7-coef-dfbetas.qmd >}}
