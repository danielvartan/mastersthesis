...
raw <- read_field_form()
tidy <- raw |> tidy_field_form()
valid <- tidy |> validate_field_form()
analysis <- valid |> analyze_field_form()
filter <- analysis |> filter_field_form()

tidy <- read_field_form() |> 
  tidy_field_form()

valid <- read_field_form() |> 
  tidy_field_form() |>
  validate_field_form()

analysis <- read_field_form() |>
  tidy_field_form() |>
  validate_field_form() |>
  analyze_field_form()

filter <- read_field_form() |>
  tidy_field_form() |>
  validate_field_form() |>
  analyze_field_form() |>
  filter_field_form()
