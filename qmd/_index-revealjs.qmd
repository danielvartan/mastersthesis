...
::: footer
(Artwork by: @merrow2020 (Left) and @duffy2011a[Figure 1, middle] (Right))
:::
...
::: footer
(Left: @leocadio-miguel2017[Figure 2] | Right: Rescaled version of the chart on the left (Created by the author))
:::
...
The MES was set at Cohen's threshold for small effects ($f^2 = 0.02$, equivalent to $\text{R}^2 = 0.01960784$) [@cohen1988a, p. 413]. Thus, latitude was considered significant only if its inclusion accounted for at least $1.960784\%$ of the variance in chronotype.
...
This study, using what is arguably the largest dataset on chronotype collected within a single time zone, balanced to reflect population proportions at the time of data collection, found [**no**]{.brandorange} support for the latitude hypothesis.
:::
...
::: footer
(Vartanian et al., 2025, Unpublished)
:::
