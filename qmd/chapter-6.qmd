...
- Broad latitudinal range: The sample spans a considerable range (`{r} res_vars$ea_analysis_sample_lat_lon$latitude[3] |> groomr:::format_to_md_latex(after = "°", max_digits = 5)`).
...
The latitudinal range of `{r} res_vars$ea_analysis_sample_lat_lon$latitude[3] |> groomr:::format_to_md_latex(after = "°", max_digits = 5)`, while substantial, could be questioned as potentially insufficient to detect latitude effects on chronotype. However, the absence of a meaningful association within this range suggests that any such effect, if present, would be minimal.
