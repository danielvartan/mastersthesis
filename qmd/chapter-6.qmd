...
According to Popper, the aim of science is to provide "satisfactory explanations of whatever strikes us as being in need of explanation" [@popper1979, p. 193]. This study, using what is arguably the largest dataset on chronotype collected within a single time zone—balanced to reflect population proportions at the time of data collection—found no support for the latitude hypothesis (Cohen's `{r} max(c(results_vars$hta_effect_size$f_squared, results_vars$htb_effect_size$f_squared)) |> format_to_md_latex(before = "f^2 = ", round = 10)`). This result contributes meaningful evidence to the understanding of circadian rhythm regulation, offering a clear and satisfactory answer to the central research question of this thesis: "Is latitude associated with chronotype?". The answer is **No**.
