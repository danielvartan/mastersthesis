...
__DV__ contributed to the design and implementation of the study. __DV__ and __MP__ collected the data. __DV__ and __CR__ performed the statistical analysis. __DV__ wrote the manuscript.
