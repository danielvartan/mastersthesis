...
[Source: Created by the author. Based on data visualization found in `\\`{=latex} @roenneberg2019b[Figure 1].{.legend}

Distribution of the local time for the sleep-corrected midpoint between sleep onset and sleep end on work-free days (MSF~sc~), a proxy for chronotype. `\microskip \\`{=latex} Chronotypes are categorized into quantiles, ranging from extremely early ($0 |- 0.11$) to extremely late ($0.88 - 1$).
:::
