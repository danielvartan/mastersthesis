...
::: {#fig-sm-correlation-matrix-full-sample}
```{r}
#| message: false
#| warning: false
...
::: {#tbl-sm-1-logitudinal-range-brazil}
```{r}
#| message: false
#| warning: false
...
::: {#tbl-sm-1-logitudinal-range-full-sample}
```{r}
#| message: false
#| warning: false
...
plot_6579_ibge_2 <- 
  ...
  plot_brazil_municipality(
    "n",
    transform = "log10",
    thematic = TRUE, # Best in viridis/plasma (or cividis) (direction = -1).
    thematic_direction = -1,
    reverse = FALSE,
...
::: {#fig-sm-1-age-sex-weigth-series}
```{r}
#| message: false
#| warning: false
...
Source: Created by the author. Based on data visualization found in @roenneberg2007a.
...
::: {#fig-sm-1-weight-latitude-series}
```{r}
#| message: false
#| warning: false

weighted_data |>
  dplyr::filter(!test_outlier(weight)) |>
...
Boxplots of mean weight values (kg) aggregated by 1° latitude intervals, illustrating the relationship between latitude and weight. The × symbol points to the mean. The red line represents a linear regression.
:::
...
```{r}
anonymized_data |> get_chronotype_cutoffs()
```


::: {#fig-sm-1-age-sex-chronotype-series}
```{r}
#| message: false
#| warning: false
...
::: {#fig-sm-2-roenneberg-2007-figure-4}
...
```{r}
weighted_data |> get_chronotype_cutoffs()
```
...
::: {#fig-sm-1-chronotype-distribution-analysis-sample}
```{r}
#| message: false
#| warning: false
...
Source: Created by the author. Based on data visualization found in @roenneberg2019b.
...
::: {#fig-sm-2-roenneberg-2019-figure-1}
...
plot_age_sex_series <- 
  weighted_data |>
  dplyr::filter(!test_outlier(weight), weight > 45) |>
  plot_series(
    col_x = "weight",
    x_label = "Weigth",
    date_breaks = "30 min",
...
::: {#fig-sm-1-chronotype-latitude-series}
```{r}
#| message: false
#| warning: false
