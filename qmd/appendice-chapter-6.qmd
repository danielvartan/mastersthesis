...
::: {#fig-appendice-chapter-6-restricted-model-residual-correlation}
```{r}
#| code-fold: false
...
::: {#fig-appendice-chapter-6-restricted-model-residual-fit-values}
```{r}
#| code-fold: false
...
[Source: Created by the author. See @cohen1988; @cohen1992 to learn more.]{.legend}
