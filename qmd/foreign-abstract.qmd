...
{{< var author-surname >}}, `r sub("\\. .\\.$", "", env_vars[["author-initials"]])`. ({{< var year >}}). _A latitude está associada à regulação do ritmo circadiano em seres humanos?_ [Dissertação de Mestrado, Universidade de São Paulo].

::: {.content-visible when-format="pdf"}
<!-- %:::% foreign-abstract reference begin %:::% -->
Vartanian, D. ({\imprimirdata}). \textit{A latitude está associada à regulação do ritmo circadiano em seres humanos?} [Dissertação de Mestrado, Universidade de São Paulo].
