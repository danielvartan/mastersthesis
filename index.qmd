...
::::
:::: {.column style="width: 47.5%;"}
![](images/sun-rhythm-rgb-96-dpi.png){fig-align="center" style="width: 80%; padding-top: 150px;"}
::::
:::::
...
:::: {.columns}
::: {.column style="width: 47.5%;"}
![](images/merrow-2023-video-1-3-figure-1-adapted.png){style="width: 100%; padding-top: 20px;"}
:::
::: {.column style="width: 5%;"}
:::
::: {.column style="width: 47.5%;"}
![](images/duffy-2011-figure-1-middle.png){style="width: 100%; padding-top: 75px;"}
:::
::::
...
The MES was set at Cohen's threshold for small effects ($f^2 = 0.02$, equivalent to $\text{R}^2 = 0.01961$) [@cohen1988a, p. 413]. Thus, latitude was considered meaningful only if its inclusion accounted for at least $1.96078\%$ of the variance in chronotype.
...
::: {style="padding-top: 15px;"}
However, similarly to @leocadio-miguel2017, when estimating Cohen’s $f^2$ effect size ($f^2 = 0.00414$), **the results were below the MES** (i.e., negligible) (**A**, `{r} md_effect_size("hta", prefix = "")`) (**B**, `{r} md_effect_size("htb", prefix = "")`).
:::
...
:::: {.columns}
::: {.column style="width: 50%; padding-top: 0px; font-size: 0.9em;"}
