...
1. Make sure that you have the latest R version and the following R packages installed in your machine: `install.packages(c("cli", "here", "magrittr", "renv", "stats", "stringr"))`.
...
1. Run `targets::tar_make()` to create and get every point of the data wrangling process (from the raw_data to the cleaned and weighted data). 
1. Open and run any analysis present in the computational notebooks.
...
The thesis was developed in the Graduate Program in Modeling Complex Systems ([PPG-SCX](https://sites.usp.br/scx/en/apresentacao/)) at the University of São Paulo ([USP](https://www5.usp.br/)), under the supervision of [Prof. Dr. Camilo Rodrigues Neto](https://orcid.org/0000-0001-6783-6695).
